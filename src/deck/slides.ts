...
export const slides: SlideDefinition[] = [
  ...
  { id: 'fetchflare', section: 'Data Prefetching: Fetchflare', Component: Fetchflare, stageCount: 5 },
  { id: 'methodology', section: 'Experimental Setup & Methodology', Component: Methodology, stageCount: 5  },
  { id: 'results-timing', section: 'Results: Timing & Frequency', Component: ResultsTiming, stageCount: 6 },
  { id: 'results-resource', section: 'Results: Resource Utilization', Component: ResultsResourceCore, stageCount: 6 },
  { id: 'results-resource-prefetch', section: 'Results: Resource Utilization', Component: ResultsResourcePrefetch, stageCount: 8 },
  { id: 'results-performance', section: 'Results: Core Performance', Component: ResultsPerformance, stageCount: 6 },
  { id: 'results-prefetch', section: 'Results: Data Prefetching', Component: ResultsPrefetch, stageCount: 7 },
  { id: 'conclusion', section: 'Conclusion & Future Prospects', Component: Conclusion, stageCount:15 },
